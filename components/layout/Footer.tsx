...
export const Footer: React.FC<FooterProps> = ({ className = '' }) => {
  return (
    <footer className={`bg-black/40 backdrop-blur-sm text-white mt-auto ${className}`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-white/80 mb-6">
              Your trusted source for luxury textiles and premium materials.
            </p>
            {/* Social Media Links */}
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>Email: info@premiumfabrics.com</li>
        ...
        <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
          <p className="text-white/80">
            &copy; {new Date().getFullYear()} Premium Fabrics. All rights reserved.
          </p>
